...
void Acelerometro::leituraVariaveis()
{
  Wire.beginTransmission(MPU);
...
uint16_t Acelerometro::accelX()
{
  return variaveis[0];
}
uint16_t Acelerometro::accelY()
{
  return variaveis[1];
}
uint16_t Acelerometro::accelZ()
{
  return variaveis[2];
}
uint16_t Acelerometro::gyroX()
{
  return variaveis[3];
}
uint16_t Acelerometro::gyroY()
{
  return variaveis[4];
}
uint16_t Acelerometro::gyroZ()
{
  return variaveis[5];
}
uint16_t Acelerometro::magX()
{
  return variaveis[6];
}
uint16_t Acelerometro::magY()
{
  return variaveis[7];
}
uint16_t Acelerometro::magZ()
{
  return variaveis[8];
}
uint16_t Acelerometro::temp()
{
  return variaveis[9];
}
